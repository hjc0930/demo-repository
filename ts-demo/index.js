...
let SomeClass = (() => {
    ...
    return _a = class SomeClass {
            constructor() {
                this.foo = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _foo_initializers, 123));
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _foo_decorators = [meta("a", "field:foo")];
